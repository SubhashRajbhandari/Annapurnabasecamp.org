...
export const FloatingConcierge: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-40">
      {!minimized ? (
        <div className="bg-white/95 backdrop-blur-xl border border-slate-200/90 shadow-2xl rounded-3xl p-3.5 sm:p-4 max-w-xs text-slate-900 transition-all duration-300 animate-fadeIn relative">
          <button
